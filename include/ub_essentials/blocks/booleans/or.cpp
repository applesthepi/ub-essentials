...
espresso::mod::block::block::execution ub_essentials::block::boolean::or_::pull_execute_release() const
{
	return execute_release;
}

espresso::mod::block::block::execution ub_essentials::block::boolean::or_::pull_execute_debug() const
{
	return execute_debug;
}

std::vector<espresso::mod::block::block::argument::initializer> ub_essentials::block::boolean::or_::get_arguments() const
{
	return {
