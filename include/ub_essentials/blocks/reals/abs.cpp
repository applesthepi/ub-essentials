...
const char* ub_essentials::block::real::abs::get_unlocalized_name() const
{
	return "essentials_real_abs";
}

const char* ub_essentials::block::real::abs::get_category() const
{
	return CATEGORY_REALS;
}

espresso::mod::block::block::execution ub_essentials::block::real::abs::pull_execute_release() const
{
	return execute_release;
}

espresso::mod::block::block::execution ub_essentials::block::real::abs::pull_execute_debug() const
{
	return execute_debug;
}

std::vector<espresso::mod::block::block::argument::initializer> ub_essentials::block::real::abs::get_arguments() const
{
	return {
