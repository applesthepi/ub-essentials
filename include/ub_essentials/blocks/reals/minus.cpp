...
const char* ub_essentials::block::real::minus::get_unlocalized_name() const { return "essentials_real_minus"; }

const char* ub_essentials::block::real::minus::get_category() const { return CATEGORY_REALS; }

cap::mod::block::block::execution ub_essentials::block::real::minus::pull_execute_release() const { return execute_release; }

cap::mod::block::block::execution ub_essentials::block::real::minus::pull_execute_debug() const { return execute_debug; }
