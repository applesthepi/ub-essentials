...
const char* ub_essentials::block::real::pi::get_unlocalized_name() const
{
	return "essentials_real_pi";
}

const char* ub_essentials::block::real::pi::get_category() const
{
	return CATEGORY_REALS;
}

espresso::mod::block::block::execution ub_essentials::block::real::pi::pull_execute_release() const
{
	return execute_release;
}

espresso::mod::block::block::execution ub_essentials::block::real::pi::pull_execute_debug() const
{
	return execute_debug;
}

std::vector<espresso::mod::block::block::argument::initializer> ub_essentials::block::real::pi::get_arguments() const
{
	return {
