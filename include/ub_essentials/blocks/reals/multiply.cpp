...
const char* ub_essentials::block::real::multiply::get_unlocalized_name() const
{
	return "essentials_real_multiply";
}

const char* ub_essentials::block::real::multiply::get_category() const
{
	return CATEGORY_REALS;
}

espresso::mod::block::block::execution ub_essentials::block::real::multiply::pull_execute_release() const
{
	return execute_release;
}

espresso::mod::block::block::execution ub_essentials::block::real::multiply::pull_execute_debug() const
{
	return execute_debug;
}

std::vector<espresso::mod::block::block::argument::initializer> ub_essentials::block::real::multiply::get_arguments() const
{
	return {
