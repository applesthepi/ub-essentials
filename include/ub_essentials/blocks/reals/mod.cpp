...
cap::mod::block::block::execution ub_essentials::block::real::mod::pull_execute_release() const
{
	return execute_release;
}

cap::mod::block::block::execution ub_essentials::block::real::mod::pull_execute_debug() const
{
