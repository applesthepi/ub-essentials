...
cap::mod::block::block::execution ub_essentials::block::real::comp_eq::pull_execute_release() const
{
	return execute_release;
}

cap::mod::block::block::execution ub_essentials::block::real::comp_eq::pull_execute_debug() const
{
