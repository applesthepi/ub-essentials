...
cap::mod::block::block::execution ub_essentials::block::string::from_real::pull_execute_release() const
{
	return execute_release;
}

cap::mod::block::block::execution ub_essentials::block::string::from_real::pull_execute_debug() const
{
