...
const char* ub_essentials::block::string::from_real::get_unlocalized_name() const
{
	return "essentials_string_from_real";
}

const char* ub_essentials::block::string::from_real::get_category() const
{
	return CATEGORY_STRINGS;
}

espresso::mod::block::block::execution ub_essentials::block::string::from_real::pull_execute_release() const
{
	return execute_release;
}

espresso::mod::block::block::execution ub_essentials::block::string::from_real::pull_execute_debug() const
{
	return execute_debug;
}

std::vector<espresso::mod::block::block::argument::initializer>
ub_essentials::block::string::from_real::get_arguments() const
{
	return {
