...
espresso::mod::block::block::execution ub_essentials::block::string::from_bool::pull_execute_release() const
{
	return execute_release;
}

espresso::mod::block::block::execution ub_essentials::block::string::from_bool::pull_execute_debug() const
{
