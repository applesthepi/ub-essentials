...
const char* ub_essentials::block::string::from_bool::get_unlocalized_name() const
{
	return "essentials_string_from_bool";
}

const char* ub_essentials::block::string::from_bool::get_category() const
{
	return CATEGORY_STRINGS;
}

cap::mod::block::block::execution ub_essentials::block::string::from_bool::pull_execute_release() const
{
	return execute_release;
}

cap::mod::block::block::execution ub_essentials::block::string::from_bool::pull_execute_debug() const
{
