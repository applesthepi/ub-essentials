...
std::string ub_essentials::category::system::get_display_name() const
{
	return "system";
}
...
std::string ub_essentials::category::booleans::get_display_name() const
{
	return "booleans";
}
...
std::string ub_essentials::category::reals::get_display_name() const
{
	return "reals";
}
...
std::string ub_essentials::category::strings::get_display_name() const
{
	return "strings";
}
